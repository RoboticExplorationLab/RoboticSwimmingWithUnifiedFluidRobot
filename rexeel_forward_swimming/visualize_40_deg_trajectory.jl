...
forward_swimming_dir = joinpath(DATA_DIR, "rexeel_forward_swimming")

hardware_tracking_path = joinpath(forward_swimming_dir, "40deg", "40deg_hardware_trajectories.csv")
simulation_path = joinpath(forward_swimming_dir, "40deg", "40deg_simulation.jld2")
motor_angles_path = joinpath(forward_swimming_dir, "40deg", "40deg_hardware_motor_angles.csv")
video_path = joinpath(forward_swimming_dir, "40deg", "Camo 录像 2026-01-27 01-11-15.mov")

# Genesis simulation paths
genesis_tracking_path = joinpath(forward_swimming_dir, "genesis_simulation_trajectories.csv")
genesis_video_path = joinpath(forward_swimming_dir, "40deg", "40deg_genesis_simulation.mp4")

# Output directory
output_dir = joinpath(VIS_DIR, "rss_figures", "40deg_forward_swimming")
mkpath(output_dir)
